...
private:
    ...
    /// bool to show whether to represent mouse history or not
    bool mShowHistory = false;

    bool mPruningActive = false;   ///< Set true when we are pruning
...
public:
    ...
    afx_msg void OnAddGarden(const std::wstring& file);
    afx_msg void OnLandscapingGardenTile();
