...
namespace Testing
{
	...
	public:
        ...
        TEST_METHOD(TestCCityVisitor)
        {
            ...
            // Test shouldn't call on any empty city
            CTestVisitor visitor;
            city.Accept(&visitor);

            Assert::AreEqual(0, visitor.mNumRoads, L"Visitor number of roads");
            Assert::AreEqual(0, visitor.mNumCoalmines, L"Visitor number of coal mines");
            ...
            Assert::AreEqual(1, visitor.mNumCoalmines, L"Visitor number of coal mines");
